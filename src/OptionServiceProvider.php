...
class OptionServiceProvider extends ServiceProvider
{
	...
	public function boot()
	{
		...
		Route::get('/option/{id}/values', [OptionController::class, 'list'])->name('option-values-list');
		Route::get('/option/{id}/value/{value_id}', [OptionController::class, 'get'])->name('option-value-get');
